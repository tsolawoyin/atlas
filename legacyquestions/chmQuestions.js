...
let chemistryQuestions = [
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          `Heaviness and non-combustibility`,
        ],
        ans: "C",
      },
      {
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        ${Heat("f", formula("H",2,"O"))}  = -286${units("kjmol", -1)}<br />
        ${Heat("f", formula("H",2,"SO",4))}  = -811${units("kjmol", -1)}`,
...

  {
    ...
    questions: [
      ...
      {
        id: 1,
        question: `If a current of 1.5 A is passed for 4.00 hours through a molten tin salt and 13.3g of tin is deposited, what is the oxidation state of the metal in the salt? <br /> [Sn = 118.7, F = 96500 C]`,
        options: [
          `1`,
          `2`,
          `3`,
      ...
      },
      {
        ...
        [Al = 27; Ag = 108]`,
        options: [`18.03g`, `5.40g`, `6.05g`, `3.03g`],
        ans: "A",
      },
      {
        id: 41,
...

  {
    ...
    questions: [
      ...
      {
        id: 61,
        question: `What type of reaction is involved when wood shavings produce a brown gas with concentrated ${formula("HNO",3)}?`,
        options: [
          `Redox reaction`,
          `Destructive distillation`,
          `Dehydration`,
